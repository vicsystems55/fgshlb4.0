                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                        <div class="vs-radio-con">
                                                            <input type="radio" name="role" value="HeadOfOperations">
                                                            <span class="vs-radio">
                                                            <span class="vs-radio--border"></span>
                                                            <span class="vs-radio--circle"></span>
                                                            </span>
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        ...
                                                        <div class="vs-radio-con">
                                                            ...
                                                            <span class="">Desk officers</span>
                                                            </div>
                                                            <span>
                                                            <label><strong>Only for Desk officers Role</strong></label>
                                            <select class="custom-select form-control" id="state" name="type">
                                            <option value="" selected="selected" >- Select Designation -</option>
                                                <option value='ministry'>Ministry</option>
                                                <option value='agency'>Parastatal/Agency</option>
                                                <option value='military'>Military/Paramiltary</option>
												 <option value='mortguage'>Mortguage</option>
