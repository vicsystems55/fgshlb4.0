          ...
          <div class="col-12">
              <div class="card bg-info text-black">
                  <div class="card-header">
                      <h4 class="card-title">Payment Approval Box</h4>
                  </div>
                      ...
                      <div class="card-body card-dashboard">
                          <div class="table-responsive">
                              <table class="table zero-configuration">
                                  ...
                                  @forelse($payment_approval_box as $loanz)
                                    ...
                                    <tr>
                                          ...
                                          <td>
                                            ...
                                            <a class="btn btn-primary shadow" href="{{route('hop.single_application', $loanz->id)}}">details</a>

                                            @endif -->
                                            <a class="btn btn-primary shadow" href="{{route('es_office.single_application', $loanz->id)}}">view</a>
                                          </td>
                                      </tr>
