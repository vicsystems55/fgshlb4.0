        ...
        <div class="navbar-collapse" id="navbar-mobile">
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <?php
                  ...
                  $nots = App\ActivityLog::where('action_by', Auth::user()->id)->where('title', '!=', 'User Authentication')->get();

            ?>
            <li class="dropdown dropdown-notification nav-item">
            <a class="nav-link nav-link-label" href="#"
                data-toggle="dropdown"><i class="ficon feather icon-bell"></i>
                <span class="badge badge-pill badge-success badge-up">{{$nots->count()}}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  <div class="bg-success dropdown-header m-0 p-2">
                    <h3 class="white">{{$nots->count()}} New</h3><span class="text-white ">App Notifications</span>
                  </div>
                </li>
                <li class="scrollable-container media-list">
                  ...
                  <a class="d-flex justify-content-between" href="javascript:void(0)">
                    ...
                    <div class="media d-flex align-items-start">
                      ...
                      <div class="media-body">
                        <h6 class="primary media-heading">{{$not->title}}</h6>
                        
                        <small class="notification-text">{{$not->log}}</small>
                      </div><small>
                        <time class="media-meta" datetime="2015-06-11T18:29:20+08:00">{{$not->created_at->diffForHumans()}}</time></small>
                    </div>
                  ...
                  <a class="d-flex justify-content-between" href="javascript:void(0)">
                    ...
                    <div class="media d-flex align-items-start">
                      <div class="media-left"><i class="feather icon-plus-square font-medium-5 primary"></i></div>
                      <div class="media-body">
                        <h6 class="primary media-heading">You have no notifications yet...</h6>
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                {{Auth::user()->surname}}</span><span class="user-status"></span></div><span><img class="round"
