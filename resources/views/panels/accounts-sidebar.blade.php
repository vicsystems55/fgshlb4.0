...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" {{ (request()->is('accounts/*','head_operations/single_application', 'head_operations/single_application/*')) ? 'active' : '' }} nav-item"><a href="{{route('accounts.all_applications')}}">
                <i class="feather icon-arrow-down"></i></i><span class="menu-title" data-i18n="Documentation">Applications</span></a>
                </li>

                <li class="{{ (request()->is('accounts/shortlisted_box')) ? 'active' : '' }} nav-item"><a href="{{route('accounts.shortlisted_box')}}">
                <i class="feather icon-arrow-down"></i></i><span class="menu-title" data-i18n="Documentation">Shortlisted Box</span></a>
                </li>

                <li class="{{ (request()->is('head_operations/earnings/')) ? 'active' : '' }} nav-item"><a href="{{route('accounts.approval_box')}}">
