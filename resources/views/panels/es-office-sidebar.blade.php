...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" {{ (request()->is('es_office/all_applications','es/single_application', 'es_office/all_applications/*')) ? 'active' : '' }} nav-item"><a href="{{route('es_office.all_applications')}}">
                <i class="feather icon-arrow-down"></i></i><span class="menu-title" data-i18n="Documentation">Applications</span></a>
                </li>

                <li class=" {{ (request()->is('es/applications','es/single_application', 'es_office/shortlisted_box')) ? 'active' : '' }} nav-item"><a href="{{route('es_office.shortlisted_box')}}">
                <i class="feather icon-arrow-down"></i></i><span class="menu-title" data-i18n="Documentation">Shortlisted Box</span></a>
                </li>

                <li class=" {{ (request()->is('es_office/approval_box')) ? 'active' : '' }} nav-item"><a href="{{route('es_office.approval_box')}}">
                <i class="feather icon-arrow-down"></i></i><span class="menu-title" data-i18n="Documentation">Approval Box</span></a>
                </li>

                <li class="{{ (request()->is('es_office/payment_approval_box')) ? 'active' : '' }} nav-item"><a href="{{route('es_office.payment_approval_box')}}">
                <i class="feather icon-arrow-down"></i></i><span class="menu-title" data-i18n="Documentation">Payment Box</span></a>
                </li>

                <li class="{{ (request()->is('es_office/payment_approval_list/')) ? 'active' : '' }} nav-item"><a href="{{route('es_office.payment_approval_list')}}">
