...
class AccountsOfficePageController extends Controller
{
    /**
    ...
    public function shortlisted_box()
    {
        ...
        return view('pages/accounts/shortlisted_box', [
            'pageConfigs' => $pageConfigs,
    ...
    public function approval_box()
    {
        ...
        return view('pages/accounts/approval_box', [
            'pageConfigs' => $pageConfigs,
    ...
    public function all_applications()
    {
        ...
        return view('/pages/accounts/all_applications', [
            'pageConfigs' => $pageConfigs,
            'loanz_applications' => $loanz_applications
        ]);
    }
    ...
    public function single_application($loan_id)
    {
        ...
        return view('pages/accounts/single_application', [
            'pageConfigs' => $pageConfigs,
    ...
    public function payment_approval_box()
    {
        ...
        return view('/pages/accounts/payment_approval_box', [
            'pageConfigs' => $pageConfigs,
